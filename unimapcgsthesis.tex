...
%% smiley face with the command \Smiley. Generally, more package  
%% loaded will increase the compilation time. 
\usepackage{marvosym}
...
\titlems{Menulis Thesis Anda dengan LaTeX dan Ia Merupakan Satu Tajuk yang Sangat Panjang Merangkumi Dua Baris}
% Academic Session
\acads{2018/2019}
% Year submitted
\submityear{2019}
% Declaration date signed
\declaredate{10 January 2019}
%% Choose only 1 degree type! :-)
\degreetype{Doctor of Philosphy}
%\degreetype{Master of Science in Biomedical Engineering}
%\degreetype{Final Year Project} 
